# Adaptation Report: {FEATURE_NAME}
...
This report documents the adaptation decisions made based on learning insights from completed features, updating patterns, methodology, and context to improve future development.

## Pattern Updates Summary

### Patterns to Update

| Pattern Name | Current Status | New Status | Changes Required | Priority |
|--------------|----------------|------------|------------------|----------|
| [Pattern 1] | [Status] | [New Status] | [Description] | [High/Med/Low] |
| [Pattern 2] | [Status] | [New Status] | [Description] | [High/Med/Low] |
...
- **Solution**: [How this pattern addresses the problem]
- **Implementation**: [How to apply this pattern in practice]
- **Evidence**: [What implementation experience supports this pattern]

### Patterns to Deprecate

| Pattern Name | Reason for Deprecation | Replacement (if any) | Date |
|--------------|------------------------|---------------------|------|
| [Pattern 1] | [Reason] | [Replacement] | [Date] |

## Methodology Refinements

### Process Improvements

1. **Phase Enhancement**: [Which ACDD phase needs updating]
   - **Current Approach**: [How it currently works]
   - **Identified Issue**: [What wasn't working well]
   - **Proposed Change**: [How to improve it]
   - **Expected Impact**: [How this will improve development]

2. **Phase Enhancement**: [Which ACDD phase needs updating]
   - **Current Approach**: [How it currently works]
   - **Identified Issue**: [What wasn't working well]
   - **Proposed Change**: [How to improve it]
   - **Expected Impact**: [How this will improve development]
...
- **Current Standard**: [What the current standard is]
- **Issue Identified**: [Why the current standard isn't sufficient]
- **Proposed Update**: [How to improve the standard]
- **Implementation Plan**: [How to apply this update]

### Tool and Template Enhancements

- **Template**: [Which template needs updating]
- **Current Issue**: [What's not working well in the template]
- **Proposed Enhancement**: [How to improve the template]
- **Expected Benefit**: [How this will improve the process]
