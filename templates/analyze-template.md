...
- Tasks: Detailed implementation steps with pattern validation
- (Preparation for eventual Learn and Adapt phases)
...
- **Scope Alignment**: Does the plan match the spec scope?
- **Issues Found**: [List any inconsistencies]
- **Resolution**: [How were inconsistencies addressed]
...
- **Success Criteria**: Do task acceptance criteria align with plan?
- **Issues Found**: [List any inconsistencies]
- **Resolution**: [How were inconsistencies addressed]
...
| [Req 2] | [How addressed in plan] | [How implemented in tasks] | [Pattern used] | [Expected outcome] |
...
- [ ] Pattern effectiveness measures are defined
...
- [ ] Pattern compliance checkpoints are defined
...
- [ ] Pattern applications are appropriate for context
...
- **Learning Opportunities**: How will pattern effectiveness be measured?
...
- **Context Evolution**: How does this feature contribute to context model?
...
- [ ] How will team evolution be tracked?
...
2. **[Risk 2]**: [Pattern, technical, or process risk]
   - **Impact**: [What happens if this risk materializes?]
   - **Probability**: [How likely is this risk?]
   - **Mitigation**: [How is this addressed in artifacts?]
...
1. **[Pattern Risk 1]**: [Issue with pattern application]
   ...
   - **Mitigation**: [How addressed in artifacts]

2. **[Pattern Risk 2]**: [Issue with pattern application]
   - **Impact**: [Effect on feature or team patterns]
   - **Probability**: [Likelihood of issue]
   - **Mitigation**: [How addressed in artifacts]
...
- [ ] Assessed quality gates and feasibility
- [ ] Evaluated learning preparation elements
...
- [ ] Learning evidence collection is planned
- [ ] Success criteria are aligned across artifacts

## Sign-off

This cross-artifact analysis confirms that the constitution, specification, plan, and tasks for **{FEATURE_NAME}** are consistent, complete, and ready for implementation with proper pattern compliance and learning preparation.
