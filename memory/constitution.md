...
- All features must follow the ACDD workflow
- Pattern compliance must be verified during implementation
- Learning outcomes must be documented after each feature
- Patterns must be updated based on evidence from implementations

## Team Practices

- Regular retrospectives to identify process improvements
- Pattern library maintenance as ongoing responsibility
- Continuous refinement of context model
