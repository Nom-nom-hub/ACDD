...
All notable changes to the ACDD (Adaptive Context-Driven Development) toolkit are documented in this file.
...
- Agent integration for major AI coding assistants
- CLI tool with `acdd init` and `acdd check` commands
